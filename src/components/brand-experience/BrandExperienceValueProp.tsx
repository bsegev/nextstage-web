...
import { IconCompass, IconFingerprint, IconVolume } from '@tabler/icons-react';

export default function BrandDesignConsultingValueProp() {
              ...
              <div className="mb-8 sm:mb-12">
                <h2 className="font-display text-3xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl tracking-[-0.02em] leading-[0.9] mb-4 sm:mb-6">
                  <span className="bg-gradient-to-r from-obsidian via-accent to-obsidian bg-clip-text text-transparent bg-[length:200%_100%] animate-gradient">
                    Where being yourself becomes your biggest advantage
                  </span>
                </h2>
                
                <div className="max-w-3xl mx-auto">
                  <p className="text-lg sm:text-lg md:text-xl leading-[1.6] text-obsidian/70 font-light">
                    Stop trying to sound like everyone else. The right customers want the real you.
                  </p>
                </div>
              </div>
                  ...
                  <div className="relative p-6 sm:p-8 text-center">
                    ...
                    <div className="relative w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-6 sm:mb-8">
                      ...
                      <div className="relative w-full h-full flex items-center justify-center">
                        <IconCompass className="w-8 h-8 sm:w-10 sm:h-10 text-accent transition-transform duration-300 group-hover:scale-110" strokeWidth={1.5} />
                      </div>
                    </div>
                    ...
                    <p className="text-base text-obsidian/65 leading-[1.6] font-light">
                      When you know who you are, every decision gets easier.
                    </p>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative p-6 sm:p-8 text-center">
                    ...
                    <div className="relative w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-6 sm:mb-8">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-accent/10 to-transparent rounded-2xl" />
                      <div className="relative w-full h-full flex items-center justify-center">
                        <IconFingerprint className="w-8 h-8 sm:w-10 sm:h-10 text-accent transition-transform duration-300 group-hover:scale-110" strokeWidth={1.5} />
                      </div>
                    </div>

                    <h3 className="text-lg font-display font-semibold text-obsidian mb-4 sm:mb-5 tracking-[-0.01em] leading-tight">
                      Natural<br/>Differentiation
                    </h3>
                    <p className="text-base text-obsidian/65 leading-[1.6] font-light">
                      Be so clearly yourself that the right people notice.
                    </p>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative p-6 sm:p-8 text-center">
                    ...
                    <div className="relative w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-6 sm:mb-8">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-accent/10 to-transparent rounded-2xl" />
                      <div className="relative w-full h-full flex items-center justify-center">
                        <IconVolume className="w-8 h-8 sm:w-10 sm:h-10 text-accent transition-transform duration-300 group-hover:scale-110" strokeWidth={1.5} />
                      </div>
                    </div>

                    <h3 className="text-lg font-display font-semibold text-obsidian mb-4 sm:mb-5 tracking-[-0.01em] leading-tight">
                      Everything<br/>Amplified
                    </h3>
                    <p className="text-base text-obsidian/65 leading-[1.6] font-light">
                      Strong brand makes your marketing, sales, and hiring way more effective.
                    </p>
                  </div>
                </div>
