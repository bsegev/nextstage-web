...
export default function EnablementTrainingMetrics() {
  ...
  const metrics = [
    {
      ...
      number: 40,
      label: "Performance\nImprovement", 
      description: "through targeted skill development that enhances team capabilities."
    },
    {
      value: "8+",
      number: 8,
      label: "Hours Weekly\nProductivity Gain",
      description: "achieved by eliminating skill gaps and knowledge bottlenecks."
    },
    {
      value: "3x",
      number: 3,
      label: "Faster\nSkill Acquisition",
      description: "with AI-powered learning that accelerates knowledge transfer."
    }
  ];
            ...
            >
              <h2 className="font-display text-3xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl tracking-[-0.02em] leading-[0.9] mb-2 sm:mb-3">
                <span className="bg-gradient-to-r from-bone via-accent to-bone bg-clip-text text-transparent bg-[length:200%_100%] animate-gradient">
                  Why Enablement & Upskilling Matters
                </span>
              </h2>
              
              <div className="max-w-2xl mx-auto">
                <p className="text-lg sm:text-base leading-[1.4] text-bone/80 font-light">
                  Research-backed results from strategic upskilling
                </p>
              </div>
            </motion.div>
