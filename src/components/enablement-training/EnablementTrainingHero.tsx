...
export default function EnablementTrainingHero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center sm:justify-start px-3 sm:px-6 lg:px-8 pt-20 sm:pt-0 overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(/images/enablement-training-hero-bg.png)',
        }}
      />
      ...
      <svg className="absolute inset-0 w-full h-full opacity-30" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice">
        <defs>
          <linearGradient id="techFlowGradient" x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        <div className="max-w-xl sm:max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto sm:mx-0 sm:ml-8 md:ml-16 lg:ml-32 xl:ml-40 2xl:ml-48 px-4 sm:px-0">
          ...
          <div className={`transition-all duration-1000 delay-300 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="mb-6 sm:mb-8 lg:mb-10 xl:mb-12 relative">
              <p className="text-lg sm:text-base md:text-lg lg:text-xl xl:text-2xl leading-[1.5] sm:leading-[1.5] text-foreground/80 font-light text-center sm:text-left max-w-md sm:max-w-lg lg:max-w-xl xl:max-w-2xl mx-auto sm:mx-0">
                Empower your people with skills that drive business success.
              </p>
            </div>
          </div>
          ...
          <div className={`transition-all duration-1000 delay-500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="text-sm text-foreground/50 font-light italic mt-6 sm:mt-8 text-center sm:text-left">
              Trusted by companies who understand that empowered teams drive business transformation
            </p>
          </div>
        </div>
      </div>
