...
export default function StrategyDeliverablesShowcase() {
  ...
  const deliverables = [
    ...
    },
    {
      ...
      category: "Validation",
      icon: IconTarget,
      href: "/deliverables/market-opportunity-analysis"
    },
    {
    ...
    },
    {
      ...
      category: "Strategy",
      icon: IconCurrency,
      href: "/deliverables/business-model-optimization"
    },
    {
      ...
      icon: IconTrendingUp,
      href: "/deliverables/competitive-intelligence"
    },
    {
