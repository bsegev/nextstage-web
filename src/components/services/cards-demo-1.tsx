...
export default function CardDemo() {
  return (
    <Card>
      ...
      <CardDescription>
        We leverage cutting-edge AI tools and technologies to deliver 
        transformative solutions that accelerate your business growth.
      </CardDescription>
    </Card>
  );
}
...
const Skeleton = () => {
  ...
  return (
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      ...
      <div className="h-40 w-px absolute top-20 m-auto z-40 bg-gradient-to-b from-transparent via-blue-400 to-transparent animate-move shadow-lg shadow-blue-400/60">
...
const Sparkles = () => {
  ...
  const sparkleData = useMemo(() => [
    ...
    { top: 55, duration: 2.9, delay: 0.9, color: 'cyan' },
    { top: 70, duration: 3.1, delay: 1.2, color: 'white' },
    { top: 85, duration: 3.3, delay: 1.5, color: 'blue' },
    { top: 15, duration: 2.7, delay: 1.8, color: 'cyan' },
    { top: 30, duration: 3.4, delay: 2.1, color: 'white' },
    { top: 45, duration: 2.6, delay: 2.4, color: 'blue' },
  ...
  const getSparkleColor = (color: string) => {
    switch (color) {
      case 'blue': return 'bg-blue-400 shadow-blue-400/80';
      case 'cyan': return 'bg-cyan-300 shadow-cyan-300/80';
      case 'white': return 'bg-white shadow-white/90';
      default: return 'bg-blue-400 shadow-blue-400/80';
    }
  };
      ...
      {sparkleData.map((sparkle, i) => (
        <motion.div
          ...
          className={cn(
            ...
            getSparkleColor(sparkle.color)
          )}
        />
      ))}
      
      {/* Add some star-shaped sparkles */}
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-2xl border border-foreground/20 bg-background/90 backdrop-blur-md shadow-[2px_4px_16px_0px_rgba(255,224,215,0.08)_inset,0px_8px_32px_0px_rgba(10,10,10,0.12)] group hover:shadow-[2px_4px_20px_0px_rgba(255,224,215,0.12)_inset,0px_12px_40px_0px_rgba(10,10,10,0.16)] transition-all duration-500",
        className
      )}
    >
      {children}
...
export const CardTitle = ({
  ...
  return (
    <h3
      className={cn(
        "font-display text-lg lg:text-xl font-semibold text-foreground tracking-[-0.02em] leading-[1.1] py-2",
        className
      )}
    >
      {children}
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "text-sm leading-relaxed text-foreground/70 font-light max-w-sm",
        className
      )}
    >
      {children}
...
export const CardSkeletonContainer = ({
  ...
  return (
    <div
      className={cn(
        "h-[15rem] md:h-[20rem] rounded-2xl z-40 relative overflow-hidden flex items-center justify-center",
        className,
        showGradient &&
          "bg-gradient-to-br from-accent/10 to-olive/10 [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]"
      )}
    ...
    >
      {backgroundImage && (
        <div className="absolute inset-0 bg-gradient-to-br from-accent/5 to-olive/5 [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]" />
      )}
