...
export default function ServicesFeatures() {
  const features = [
    ...
    },
    {
      ...
      description: "Strategy, design, and technology work together, creating solutions that are better than the sum of their parts.",
      icon: <IconTrendingUp />,
    },
    {
      title: "Built for Growth",
      description: "We consider technical needs from the start, while strategic vision guides technical architecture from the beginning.",
      icon: <IconBulb />,
    },
    {
      title: "Fast Delivery",
      description: "Get from idea to launch quickly—without sacrificing quality or strategic depth.",
      icon: <IconTarget />,
    },
    {
      title: "We Work With You",
      description: "We work alongside your team, building your capabilities while delivering results—not just consulting reports.",
      icon: <IconUsers />,
    },
    {
      title: "Proven Results",
      description: "For businesses of all sizes, leaders choose our integrated approach when speed and quality both matter.",
      icon: <IconStar />,
    },
    {
    ...
    {
      title: "Clear Results",
      description: "See results from the beginning with clear metrics, working prototypes, and tangible business outcomes.",
      icon: <IconPalette />,
    },
  ];
