...
export const BusinessOpportunityAnalyzer = ({ 
  ...
  return (
    <div className="min-h-screen bg-obsidian text-bone">
      {/* Header */}
      <div className="bg-obsidian/95 backdrop-blur-sm border-b border-accent/20 px-6 py-4 sticky top-0 z-10 print:hidden">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="font-display text-xl font-medium text-bone">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="flex items-center space-x-2 bg-accent/10 hover:bg-accent/20 px-4 py-2 rounded-lg transition-colors"
              >
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 space-y-8">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="bg-accent/5 rounded-lg p-4">
                  <h4 className="text-bone font-medium mb-2">Search Provider</h4>
                  <p className="text-bone/70 text-sm">
                    {analysis.searchProvider === 'brave' ? 'Brave Search API' : 'Anthropic Web Search'}
                  </p>
                </div>
                <div className="bg-accent/5 rounded-lg p-4">
                  <h4 className="text-bone font-medium mb-2">Research Cost</h4>
                  <p className="text-bone/70 text-sm">
                ...
                <div className="mt-4 pt-4 border-t border-accent/10">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                    <div>
                      ...
                      <p className="text-bone font-medium">{analysis.searchMetrics.queriesExecuted}</p>
                    </div>
                    <div>
                      <p className="text-bone/50 text-xs">Success Rate</p>
                      <p className="text-bone font-medium">{(analysis.searchMetrics.successRate * 100).toFixed(0)}%</p>
                    </div>
                    <div>
                      <p className="text-bone/50 text-xs">Provider</p>
                      <p className="text-bone font-medium">{analysis.searchMetrics.provider}</p>
                    </div>
                    <div>
                      <p className="text-bone/50 text-xs">Cost</p>
                      <p className="text-bone font-medium">${analysis.searchMetrics.cost.toFixed(3)}</p>
                    </div>
                  </div>
                </div>
              )}
        ...
        <motion.div
          ...
          className="bg-accent/5 border border-accent/10 rounded-2xl p-6"
        >
          <h2 className="font-display text-2xl font-semibold text-bone mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="bg-accent/10 border border-accent/20 rounded-lg px-4 py-2 text-bone placeholder-bone/50 focus:outline-none focus:border-accent/40"
              />
              <button
                onClick={handleSendEmail}
                disabled={isLoadingEmail || !email.trim()}
                className="bg-accent/20 text-bone px-4 py-2 rounded-lg hover:bg-accent/30 transition-colors disabled:opacity-50"
              >
