...
export default function NSTechHero() {
  return (
    <section className="relative min-h-screen lg:min-h-[95vh] flex items-center justify-center sm:justify-start px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Background image with modern loading pattern - matching your design */}
      <div 
        className="absolute inset-0 bg-cover bg-center bg-no-repeat transition-opacity duration-700"
        style={{
          backgroundImage: 'url(/images/ai-flow.png)',
        }}
      />
      
      {/* Enhanced overlay system for better text contrast - your exact pattern */}
      ...
      {/* Dynamic floating orbs - your exact style */}
      <motion.div 
      ...
      {/* Main content - your exact structure */}
      <div className="relative z-10 w-full">
        <div className="max-w-xl sm:max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto sm:mx-0 sm:ml-8 md:ml-16 lg:ml-32 xl:ml-40 2xl:ml-48 px-4 sm:px-0">
          ...
          {/* Headline with your exact typography */}
          <motion.div 
            ...
            <div className="mb-6 sm:mb-8 lg:mb-10 xl:mb-12 relative">
              <p className="text-lg sm:text-base md:text-lg lg:text-xl xl:text-2xl leading-[1.5] sm:leading-[1.5] text-foreground/80 font-light text-center sm:text-left max-w-md sm:max-w-lg lg:max-w-xl xl:max-w-2xl mx-auto sm:mx-0">
                ...
                <span className="relative inline-block">
                  <span className="text-foreground font-medium">AI-powered applications and tools</span>
                  <span className="absolute bottom-0 left-0 w-full h-[1px] bg-gradient-to-r from-accent/50 to-accent/25 block" />
                </span>
                {' '}designed to accelerate your business growth and strategic planning.
              </p>
            </div>
          </motion.div>
          
          {/* CTA Buttons - your exact style */}
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="flex flex-col sm:flex-row items-center sm:items-start justify-center sm:justify-start gap-4 sm:gap-6">
              {/* Primary CTA - your obsidian/bone style */}
              <Link href="/strategy-brief" className="group relative w-full sm:w-auto min-h-[56px] touch-manipulation focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 focus-visible:ring-offset-2 rounded-full">
              ...
              {/* Secondary CTA - your exact LiquidGlass style */}
              <a href="https://cal.com/bensegev/30min" target="_blank" rel="noopener noreferrer" className="group relative w-full sm:w-auto min-h-[56px] touch-manipulation focus:outline-none focus-visible:ring-2 focus-visible:ring-bone/50 focus-visible:ring-offset-2">
                <LiquidGlass 
                  intensity="subtle" 
                  animated
