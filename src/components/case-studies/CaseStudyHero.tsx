...
export default function CaseStudyHero({ data }: CaseStudyHeroProps) {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-background dark:bg-[#0B0B0F]">
      ...
      {/* Header Content - Outside MacBook for performance */}
      <div className="relative z-20 max-w-6xl mx-auto text-center px-6 sm:px-8 md:px-10 lg:px-12 pt-20 sm:pt-16 md:pt-12 lg:pt-8">
        <div className="space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-12 max-w-[100vw] mt-[15vh] sm:mt-[10vh] md:mt-[5vh] lg:mt-0">
          ...
          {/* Featured Meta Information - Mobile Optimized */}
          <motion.div 
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      {/* Simple MacBook Component - Like Original Demo */}
