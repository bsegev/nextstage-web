...
export default function CaseStudyResults({ data }: CaseStudyResultsProps) {
  return (
    <section className="py-20 lg:py-32 bg-gradient-to-br from-background via-background/95 to-accent/5 dark:from-obsidian dark:via-obsidian/95 dark:to-accent/5">
