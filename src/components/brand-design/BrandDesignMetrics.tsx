  ...
  const metrics = [
    {
      ...
      description: "Companies with consistent brand presentation see up to 33% revenue increase."
    },
    {
      value: "0.05s",
      number: 0.05,
      label: "To Win Attention",
      description: "You have 50 milliseconds to capture attention and create positive first impressions that last."
    },
    {
      value: "5x",
      number: 5,
      label: "Higher Conversions",
      description: "Top-performing companies achieve conversion rates 3x to 5x higher than average through superior design."
    }
  ];
