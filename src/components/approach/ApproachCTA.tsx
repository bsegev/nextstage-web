        ...
        <div className="lg:hidden space-y-8">
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              <span className="text-bone text-sm font-medium tracking-wide">Ready to make it happen</span>
            </motion.div>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-lg sm:text-base lg:text-lg text-bone/75 font-light max-w-2xl mx-auto leading-relaxed">
              Transform your approach from <span className="text-bone/90 font-medium">theory to execution</span> with a partner who gets both strategy and speed.
            </p>
          </div>

          {/* Mobile Convergence Geometry - Placeholder for new animation */}
          <div className="relative h-80">
            <motion.div
              className="absolute inset-0 flex items-center justify-center"
              style={{ rotate: geometryRotate, scale: geometryScale }}
            >
              {/* Convergence Geometry - Mobile Optimized - TO BE REPLACED */}
          ...
          >
            <p className="text-lg sm:text-base lg:text-lg text-bone/70 font-light leading-relaxed max-w-lg mx-auto">
              When your vision meets our proven approach, 
              breakthrough results happen in <strong className="text-accent font-semibold">weeks, not quarters</strong>.
            </p>
          </motion.div>
          ...
          >
            <p className="text-sm text-bone/50 font-light italic">
              Join the leaders who choose action over hesitation
            </p>
          </motion.div>
        </div>
        ...
        <div className="hidden lg:grid grid-cols-12 gap-16 items-center min-h-[60vh]">
          ...
          <div className="col-span-7 space-y-12 text-left">
            ...
            >
              ...
              <span className="text-bone font-medium tracking-wide">Ready to make it happen</span>
            </motion.div>
            ...
            >
              <p className="text-lg sm:text-base lg:text-lg text-bone/70 font-light leading-relaxed">
                When your vision meets our proven approach, 
                breakthrough results happen in weeks, not quarters.
              </p>
            </motion.div>
          ...
          {/* Visual Side - Right (Desktop Only) - TO BE REPLACED WITH NEW ANIMATION */}
          <div className="col-span-5 relative h-96 lg:h-full">
            <motion.div
              className="absolute inset-0 flex items-center justify-center"
              style={{ rotate: geometryRotate, scale: geometryScale }}
            >
              {/* Convergence Geometry - TO BE REPLACED */}
