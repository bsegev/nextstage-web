...
export default function GrowthMarketingDeliverablesShowcase() {
        ...
        <div className={`text-center mb-12 sm:mb-16 md:mb-20 lg:mb-24 transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="text-3xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-display tracking-[-0.02em] leading-[0.9] mb-4 sm:mb-6 md:mb-8">
            <span className="bg-gradient-to-r from-obsidian via-accent to-obsidian bg-clip-text text-transparent bg-[length:200%_100%] animate-gradient">
              Tangible systems you can implement immediately
            </span>
          </h2>
          
          <p className="text-lg sm:text-lg md:text-xl lg:text-2xl text-obsidian/80 font-light leading-relaxed max-w-4xl mx-auto">
            No abstract strategies—just practical tools that drive real business growth and measurable results.
          </p>
        </div>
