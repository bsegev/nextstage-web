...
export default function GrowthMarketingMetrics() {
  ...
  const metrics = [
    {
      ...
      description: "before they'll consider buying from your brand",
      delay: 0
    },
    {
      value: "75,000+",
      ...
      description: "to deliver tailored customer experiences",
      delay: 200
    },
    {
      value: "5x",
      ...
      description: "compared to first-time buyers",
      delay: 400
    }
  ];
            ...
            >
              <h2 className="font-display text-3xl sm:text-2xl md:text-3xl tracking-[-0.02em] leading-[0.9] mb-2 sm:mb-3">
                <span className="bg-gradient-to-r from-bone via-accent to-bone bg-clip-text text-transparent bg-[length:200%_100%] animate-gradient">
                  Why Marketing & Growth Matters
                </span>
              </h2>
              
              <div className="max-w-2xl mx-auto">
                <p className="text-lg sm:text-base leading-[1.4] text-bone/80 font-light">
                  Research-backed performance from customer-focused strategies
                </p>
              </div>
            </motion.div>
