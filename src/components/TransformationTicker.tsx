...
export default function TransformationTicker() {
  return (
    <div className="py-12 sm:py-16 md:py-20 bg-background relative overflow-hidden">
      {/* Section header */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 mb-8 sm:mb-12">
        <div className="text-center">
          ...
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-[-0.02em] leading-[0.9] mb-4 sm:mb-6 text-foreground">
          ...
          <p className="text-base sm:text-lg text-foreground/75 font-light max-w-2xl mx-auto">
...
// Demo data - will be replaced with your transformation format
